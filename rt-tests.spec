...
Version  : 2.5
Release  : 31
URL      : https://mirrors.kernel.org/pub/linux/utils/rt-tests/rt-tests-2.5.tar.xz
Source0  : https://mirrors.kernel.org/pub/linux/utils/rt-tests/rt-tests-2.5.tar.xz
...
%prep
%setup -q -n rt-tests-2.5
cd %{_builddir}/rt-tests-2.5
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674261326
