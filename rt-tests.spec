...
Source0  : https://mirrors.kernel.org/pub/linux/utils/rt-tests/rt-tests-2.8.tar.gz
...
%prep
%setup -q -n rt-tests-2.8
cd %{_builddir}/rt-tests-2.8
%patch -P 1 -p1
pushd ..
cp -a rt-tests-2.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1733238608
