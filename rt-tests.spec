...
Version  : 2.3
Release  : 28
URL      : https://mirrors.kernel.org/pub/linux/utils/rt-tests/rt-tests-2.3.tar.xz
Source0  : https://mirrors.kernel.org/pub/linux/utils/rt-tests/rt-tests-2.3.tar.xz
...
%prep
%setup -q -n rt-tests-2.3
cd %{_builddir}/rt-tests-2.3
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1640647453
...
cp %{_builddir}/rt-tests-2.3/COPYING %{buildroot}/usr/share/package-licenses/rt-tests/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
cp %{_builddir}/rt-tests-2.3/src/pi_tests/COPYING %{buildroot}/usr/share/package-licenses/rt-tests/17e3b0eea99abffe6ac71e65627413236e0b117a
%make_install
